...
const useAppStore = defineStore('app', () => {
    ...
    const network_chainId = 11155111
    const myFactoryAddress = "0x3581F04C67b5B26D0303b27B89A1319B69D3097F"
    const myRouterAddress = "0xB4B1D410e0bCe84a99015fF77a34a1233669F4Ed"
    const tokenAAddress = "0x7a044CD0A7AFf6a6f1138D33C6B56dE5F35bf426"
    const tokenBAddress = "0x3184A672dD2C67c9a49a013c1dAf85984Ea1B315"
    const tokenCAddress = "0x6d97eE4110Ecf00981c0002274f6498F12b81c81"
    ...
    const dappInit = async () => {
        try {
            ...
            if (window.ethereum.chainId !== network_chainId && window.ethereum.networkVersion !== String(network_chainId)) {
                throw { code: -1, message: "Switch to the Sepolia network" }
            }
            ...
            dapp.myRouter = new dapp.web3.eth.Contract(MyRouter, myRouterAddress)
            dapp.myFactory = new dapp.web3.eth.Contract(MyFactory, myFactoryAddress)
            dapp.tokenA = new dapp.web3.eth.Contract(TokenA, tokenAAddress)
            dapp.tokenB = new dapp.web3.eth.Contract(TokenB, tokenBAddress)
            dapp.tokenC = new dapp.web3.eth.Contract(TokenC, tokenCAddress)
    ...
    const getBalance = async () => {
        ...
        try {
            ...
            const pairAB = new dapp.web3.eth.Contract(MyPair, res1)
        ...
        try {
            ...
            const pairAC = new dapp.web3.eth.Contract(MyPair, res2)
        ...
        try {
            ...
            const pairBC = new dapp.web3.eth.Contract(MyPair, res3)
